...
// Fetch only active sales admin users
$usersQuery = "SELECT id, name FROM users WHERE role = 'salesadmin' AND active = 1 ORDER BY name";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Fetch sales data for the selected user or all users (only "salesadmin" role users and active)
    if ($selectedUser !== 'all') {
...
<script src="script.js?v=1.0.1"></script>
  ...
  <body class="">
   ...
   <form id="export-form" action="export_report.php" method="post" style="display:inline;">
    ...
    &nbsp; &nbsp; &nbsp;<a href="sales_report.php" class="btn btn-primary" style="width: 13%; padding: 6px 12px;">Sales</a>
</form>
                                    <br>
