...
<script src="script.js?v=1.0.1"></script>
  ...
  <body class="">
   ...
   &nbsp; &nbsp; &nbsp; <a href="sales_admin.php" class="btn btn-primary" style="width: 13%; padding: 6px 12px;">Sales Admin</a>
</form>
                                    <br>
    ...
    // Automatically submit the form on page load if no user is selected or date is not set
        if ($('#userId').val() === 'all' && !$('#startDate').val() && !$('#endDate').val()) {
            $('#userFilterForm').submit();
        }
    });
