...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO daily_sales (user_id, sales, target, date, sale_type) VALUES (:sales_user_id, :sales, :target, :date, :sale_type)";
    ...
    $stmt->bindParam(':sale_type', $sales_type); // Corrected key here

    if ($stmt->execute()) {
        $success = "Sales data updated successfully";
    } else {
...
$sales_users_stmt = $conn->prepare("SELECT id, name FROM users WHERE role = 'sales'");
$sales_users_stmt->execute();
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="form-group">
                                <label for="sales">Sales Achieved</label>
                                <input type="number" name="sales" id="sales" class="form-control" required>
                            </div>
                            <div class="form-group">
