...
$sales_stmt = $conn->prepare("SELECT ds.id, u.name, ds.sales, ds.target, ds.sale_type, ds.rejects FROM daily_sales ds JOIN users u ON ds.user_id = u.id WHERE ds.date = :date");
            ...
            <div class="card-body">
                ...
                <form method="get" action="edit_sales.php">
                    <div class="form-group">
                        ...
                        <input type="date" id="date" name="date" value="<?php echo $date; ?>" class="form-control" onchange="this.form.submit()">
                    </div>
                </form>
                    ...
                    <tbody>
                        <?php foreach ($sales_data as $sale) { ?>
                            <tr data-sale-id="<?php echo $sale['id']; ?>">
                                ...
                                <td><input type="text" name="target" value="<?php echo $sale['target']; ?>" readonly></td>
                                <td><input type="text" name="sales" value="<?php echo $sale['sales']; ?>" readonly></td>
                                <td><?php echo $sale['sale_type']; ?></td>
                                <td><input type="text" name="rejects" value="<?php echo $sale['rejects']; ?>" readonly></td>
                                <td><input type="text" name="active_leads" readonly></td>
                                <td><input type="text" name="active_quotes" readonly></td>
                                <td><input type="text" name="awaiting_docs" readonly></td>
                                <td><input type="text" name="monthly_target" readonly></td>
                                <td><input type="text" name="current_monthly_sale" readonly></td>
                                <td>
