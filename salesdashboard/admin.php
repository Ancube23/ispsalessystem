...
// Fetch user data
$sql = "SELECT id, name, email, role, created_at, updated_at FROM users WHERE role = 'sales'";
$stmt = $conn->query($sql);
...
<script src="script.js?v=1.0.1"></script>
  ...
  <body class="">
    ...
    <div id="slideshow" class="slideshow">
        <!-- Slide 1: Yesterday's sales with target -->
        <div class="slide" id="slide1"></div>
        <!-- Slide 2: Sales progress for the past month -->
        <div class="slide" id="slide2"></div>
        <!-- Slide 3: Overall sales and target achieved -->
        <div class="slide" id="slide3"></div>
        
    </div>
    <!-- Pause/Play button --><div id="pausePlayBtn" class="bottom-button">
    <img src="pause.png" alt="Pause" class="button-icon" id="pausePlayIcon">
</div>
    ...
    // Fetch and display the initial data for each slide
    fetchSlideData('fetch_sales2.php', 'slide1');
    fetchSlideData('fetch_sales3.php', 'slide2');
    fetchSlideData('fetch_sales4.php', 'slide3');

    // Slideshow interval (4 seconds)
    var intervalId = setInterval(nextSlide, 4000);

    // Pause/Play button click event handler
    $('#pausePlayBtn').click(function() {
        var $icon = $('#pausePlayIcon');
        if ($icon.attr('src') === 'pause.png') {
    ...
    // Function to fetch data for a slide and display it
    function fetchSlideData(url, slideId) {
        $.ajax({
            url: url,
            method: 'GET',
